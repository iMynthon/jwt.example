...
import mynthon.jwt.example.jwt.example.filter.JwtAuthenticationFilter;
import mynthon.jwt.example.jwt.example.security.JwtAuthConverter;
import mynthon.jwt.example.jwt.example.web.dto.response.ErrorResponse;
...
public class SecureConfig {
    ...
    @Bean
    public FilterRegistrationBean<JwtAuthenticationFilter> tokenFilter(AuthenticationManager authenticationManager, JwtAuthConverter jwtAuthConverter) {
        JwtAuthenticationFilter bearerAuthFilter =
                new JwtAuthenticationFilter(authenticationManager,jwtAuthConverter);
